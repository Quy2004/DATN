                    ...
                    <div className=" flex justify-between items-center container mx-auto inner-header ">
                        ...
                        <nav aria-label="Global" className="hidden md:block">
                            <div className="flex  text-sm font-semibold" id="main-menu">
                                <div className="px-4">
                                    <Link to={"/login"} type="button" className=" px-6 border-r-2 border-[#]">
                                ...
                                <div className="px-4">
                                    <button className="h-[24px] *:hover:opacity-80" onClick={() => setIsOpen(true)}>
                                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5"
                                            stroke="currentColor" className="size-6 w-[24px]">
                                            <path strokeLinecap="round" strokeLinejoin="round"
                                                d="M15.75 10.5V6a3.75 3.75 0 1 0-7.5 0v4.5m11.356-1.993 1.263 12c.07.665-.45 1.243-1.119 1.243H4.25a1.125 1.125 0 0 1-1.12-1.243l1.264-12A1.125 1.125 0 0 1 5.513 7.5h12.974c.576 0 1.059.435 1.119 1.007ZM8.625 10.5a.375.375 0 1 1-.75 0 .375.375 0 0 1 .75 0Zm7.5 0a.375.375 0 1 1-.75 0 .375.375 0 0 1 .75 0Z" />
                                        </svg>
                                        <span className="absolute bg-red-500 bottom-3 rounded-[50%] w-[16px] h-[16px] text-xs text-white">0</span>
                                    </button>
                                </div>
                            </div>
                        </nav>
