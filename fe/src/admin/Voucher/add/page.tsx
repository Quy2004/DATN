  ...
  return (
    <>
      <div className="flex items-center justify-between mb-5">
        ...
        <Button className="ml-[504px]" onClick={generateRandomCode}>
          Tạo mã ngẫu nhiên
        </Button>
      ...
      <div className="w-full mx-auto overflow-y-auto max-h-[400px]">
        ...
        >
          ...
          <Form.Item label="Áp dụng cho:" className="mb-4 ">
            <div>
              {/* <Button
          ...
          {/* Mô tả */}
          <Form.Item label="Mô tả voucher" name="description" className="mt-5">
            <ReactQuill theme="snow" placeholder="Nhập mô tả voucher" />
          </Form.Item>
