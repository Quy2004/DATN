                    ...
                    <div className="w-full md:mt-0 sm:max-w-md xl:p-0 dark:bg-gray-800 dark:border-gray-700">
                        <div className="p-6 space-y-4 md:space-y-6 sm:p-8">
                            ...
                            <form className="space-y-4 md:space-y-6" action="#">
                                ...
                                <div>
                                    <label htmlFor="confirm-password" className="block mb-2 text-sm font-medium text-gray-900 dark:text-white text-left">Nhập lại mật khẩu</label>
                                ...
                                <div className="flex items-start">
                                    ...
                                    <div className="ml-3 text-sm">
                                        <label htmlFor="terms" className="font-light text-gray-500 dark:text-gray-300">Tôi chấp nhận các <a className="font-medium text-primary-600 hover:underline dark:text-primary-500" href="#">điều khoản và điều kiện</a></label>
                                    </div>
                                </div>
                                ...
                                <p className="text-sm font-light text-gray-500 dark:text-gray-400">
                                    Bạn đã có tài khoản? <Link to={'/signin'} className="font-medium text-red-600 hover:underline dark:text-primary-500">Đăng nhập tại đây</Link>
                                </p>
                            </form>
                        </div>
                    </div>
