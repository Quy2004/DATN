                        ...
                        <div className="rounded-lg border border-gray-200 bg-white p-4 shadow-sm dark:border-gray-700 dark:bg-gray-800 md:p-6">
                            <div className="space-y-4 md:flex md:items-center md:justify-between md:gap-6 md:space-y-0">
                                <div className="flex items-center md:order-1">
                                    ...
                                    <Link to="">
                                        <img className="h-20 w-20 dark:hidden" src="src/pages/CartPage/Trà Đào 3.jpg" alt="imac image" />
                                    </Link>
                                </div>
                                {/* Số lượng */}
                                ...
                                <div className="w-full min-w-0 flex-1 space-y-3 md:order-2 md:max-w-md">
                                    <a href="#" className="text-base font-medium text-gray-900 hover:underline dark:text-white">Trà đào cam sả</a>
                                    {/* Size */}
                                    <div className="mx-2">
                                    ...
                                    {/* Topping */}
                                    <div className="mx-2">
                                        <p className="text-sm">Topping: Thạch</p>
                                    </div>
                            ...
                            <div className="space-y-4">
                                <div className="space-y-2">
                                    <dl className="flex items-center justify-between gap-4">
                                        <dt className="text-base font-normal text-gray-500 dark:text-gray-400">Tên sản phẩm</dt>
