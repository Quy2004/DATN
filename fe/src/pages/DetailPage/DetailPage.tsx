                            ...
                            <div className="w-[55%] px-4">
                                ...
                                ${selectedSize?.size_id._id === size.size_id._id
                                                        ...
                                                        >
                                                            ...
                                                            <span className="ml-2 text-sm">+ {listPrice(size.size_id.priceSize || 0)} VNĐ</span> {/* Hiển thị giá size */}
                                                        </button>
                                                    ))}
                                                </div>
                                            ) : (
                                            ...
                                            {selectedProduct ? (
                                                <form className="flex flex-col my-1 rounded-md">
                                                    {selectedProduct.product_toppings.map((topping) => {
                                                        return <div key={topping.topping_id._id} className="flex items-center gap-2 px-2 py-2 border-b border-gray-200">
                                                            <input
                                                                type="checkbox"
                                                                name="topping"
