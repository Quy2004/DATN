                            ...
                            <div className="w-full md:w-1/2 px-4 mb-8">
                                ...
                                <div className="flex gap-4 py-4 justify-center overflow-x-auto">
                                    {Array.isArray(product.thumbnail) && product.thumbnail.slice(0, 4).map((thumb, index) => (
                                        <img key={index} src={thumb} alt={`Thumbnail ${index + 1}`} className="size-16 sm:size-20 object-cover rounded-md cursor-pointer opacity-60 hover:opacity-100 transition duration-300" />
                                    ))}
                                </div>
                            </div>
