    ...
    <>
      <div className="container px-4 mx-auto mb-12">
        <div className="header_homes text-center ">
          ...
          <p className="text-sm w-full md:w-[53%] mx-auto text-center mt-3 leading-loose">
        ...
        <div className="tabs my-6">
          <ul className="flex flex-wrap justify-center text-sm md:text-lg font-semibold gap-2 md:gap-5">
            {tabs.map((tab) => (
              <li
                key={tab.title}
                className={`${
              ...
              >
                <span
                  className={`px-4 md:px-8 py-1 md:py-[10px] ${
                    activeTab === tab.title ? "text-orange-500" : ""
                  }`}
                >
                  {tab.title}
                </span>
